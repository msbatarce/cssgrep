...
_cssgrep() {
    ...
    opts="-e --selector -r --recursive --max-depth --ext --include -i --ignore --exclude --ignore-file -S --follow -n --line-number \
...
--color -h --help -V --version"
    ...
    case "$prev" in
        ...
        --ignore-file)
            ...
            return 0
            ;;
        -e|--selector|--max-depth|--ext|--include|-i|--ignore|--exclude|--attr|--parent|-w|--max-width|-A|--after-context|\
